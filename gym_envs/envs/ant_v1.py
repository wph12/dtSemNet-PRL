...
import os
class AntV1Env(mujoco_env.MujocoEnv, utils.EzPickle):
    FILE = os.path.dirname(os.path.realpath(__file__)) + '/../assets/ant_v1.xml'
    ORI_IND = 3
    ...
    def __init__(self, file_path=None, expose_all_qpos=True,
        ...
        mujoco_env.MujocoEnv.__init__(self, FILE, 5)
    ...
    def _get_obs(self):
        ...
        if self._expose_all_qpos:
            ...
            obs = np.concatenate([
                ...
                # under construction
                # also exclude z-position
                self.physics.data.qpos.flat[3:15], 
                self.physics.data.qvel.flat[:14],
            ])
...
# Under construction
class AntV1UpEnv(AntV1Env):

    def __init__(self, file_path=None, expose_all_qpos=False,  # should be independent here
               expose_body_coms=None, expose_body_comvels=None):
        self._expose_all_qpos = expose_all_qpos
        self._expose_body_coms = expose_body_coms
        self._expose_body_comvels = expose_body_comvels
